...
public class MoneyUtil {
   ...
   * @return
   */
  public static String toChinaMoney(String money){
    try {
      return NumberFormat.getCurrencyInstance(Locale.CHINA).format(Double.parseDouble(money));
    }catch (Exception e){
      e.printStackTrace();
    }
    return "";
...
//    System.out.println(MoneyUtil.toChinaUpper("12000.23"));
  }
}
